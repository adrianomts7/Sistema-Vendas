...
const VendasModel = sequelize.define(
  "vendas",
  {
    ...
    produtoId: {
      type: DataTypes.INTEGER,
      field: "produto_id", // Como ele se chama no banco de dados
      allowNull: false,
      validate: {
        min: {
          args: 1,
...
VendasModel.belongsTo(Produtos, { foreignKey: "produtoId", as: "produto" });
VendasModel.belongsTo(Users, { foreignKey: "vendedorId", as: "vendedor" });
